...
import { Grid, Box, TextField, Typography, IconButton, Button } from '@mui/material';
...
<Box sx={{ width: '100%' }}>
      ...
      <Grid container spacing={2} justifyContent="center" sx={{margin:{xs:"3%"}, marginTop: 4, width: "auto" }}>
        <Grid
          item
          xs={12}
          md={8}
