        ...
        <Grid container spacing={2} alignItems="center">
          <Grid item>
            <Button sx={{ display: 'flex', alignItems: 'center' }}>
              <TranslateOutlinedIcon sx={{ marginRight: 1 }} />
              <Typography variant="body2">EN</Typography>
            </Button>
          </Grid>
          <Grid item>
            <Grid container spacing={1} alignItems="center">
              <Grid item><WatchLaterOutlinedIcon /></Grid>
              <Grid item><Typography variant="body2">Mon-Fri 10:00 AM to 08:00 PM</Typography></Grid>
            </Grid>
          </Grid>
          <Grid item>
            <Grid container spacing={1}>
              <Grid item><CallOutlinedIcon /></Grid>
              <Grid item><Typography variant="body2">+91 9876543210</Typography></Grid>
            </Grid>
          </Grid>
          <Grid item>
            <Grid container spacing={1} alignItems="center">
              <Grid item><EmailOutlinedIcon /></Grid>
              <Grid item><Typography variant="body2">customercare@fincoopers.com</Typography></Grid>
            </Grid>
          </Grid>
          <Grid item>
